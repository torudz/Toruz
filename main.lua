...
function Library:CreateWindow(panelName, userName)
    ...
    ContentFrame.Size = UDim2.new(0, 330, 1, -45)
    ...
    function Window:AddDropdown(text, options, callback)
        ...
        DBtn.MouseButton1Click:Connect(function()
            ...
            TweenService:Create(DFrame, TweenInfo.new(0.3), {
                Size = open and UDim2.new(1, 0, 0, 30 + (#options * 25)) or UDim2.new(1, 0, 0, 30)
            }):Play()
            ...
            if open then
                for i, v in pairs(options) do
                    ...
                    Opt.MouseButton1Click:Connect(function()
                        ...
                        callback(v)
                        open = false
                        TweenService:Create(DFrame, TweenInfo.new(0.3), {Size = UDim2.new(1, 0, 0, 30)}):Play()
    ...
    -- [HÀM SLIDER PHONG CÁCH PANEL]
    function Window:AddSlider(text, min, max, default, callback)
        local SFrame = Instance.new("Frame")
        SFrame.Size = UDim2.new(1, 0, 0, 45)
        SFrame.BackgroundTransparency = 1
        SFrame.Parent = ContentFrame
