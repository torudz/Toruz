...
function Library:CreateWindow(panelName, userName)
    ...
    -- Nút Power và Tiêu đề giữ nguyên như cũ
    ...
    -- Khung chứa tất cả các Tab Pages
    ...
    function Window:AddTab(name, icon)
        ...
        -- Khung nội dung riêng cho từng Tab (ScrollingFrame)
        ...
        -- Các hàm con (Toggle, Slider, Dropdown) phải nằm trong TabPage
